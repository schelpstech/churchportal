            ...
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">New Visitor's Information Slip</h3>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" data-target-input="nearest">
                                            <input type="tel" class="form-control" id="phonenumber" name="phonenumber" required="yes" tabindex="7" />
                                            <div class="input-group-append">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" data-target-input="nearest">
                                            <input type="tel" class="form-control" id="alt_phonenumber" name="alt_phonenumber" tabindex="8" />
                                            <div class="input-group-append">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" data-target-input="nearest">
                                            <input type="email" class="form-control" id="emailaddress" name="emailaddress" tabindex="9" />
                                            <div class="input-group-append">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" data-target-input="nearest">
                                            <input type="text" class="form-control" id="nearest_busstop" name="nearest_busstop" required="yes" tabindex="10" />
                                            <div class="input-group-append">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" data-target-input="nearest">
                                            <input type="text" class="form-control" id="full_address" name="full_address" required="yes" tabindex="11" />
                                            <div class="input-group-append">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" data-target-input="nearest">
                                            <input type="text" class="form-control" id="town" name="town" required="yes" tabindex="12" />
                                            <div class="input-group-append">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group" id="type-residence_state" style="display: none ;">
                                        ...
                                        <div class="input-group date" data-target-input="nearest">
                                            <input type="text" class="form-control" id="residence_state-text" tabindex="14" />
                                            <div class="input-group-append">
                                    ...
                                    <div class="form-group" id="select-residence_state">
                                        ...
                                        <div class="input-group date">
                                            <select type="text" class="form-control" id="residence_state-select" onchange="fetch_residence_lga()" tabindex="14">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group" id="select-residence_lga">
                                        ...
                                        <div class="input-group date">
                                            <select type="text" class="form-control" id="residence_lga-select" tabindex="15">
                                    ...
                                    <div class="form-group" id="type-residence_lga" style="display: none ;">
                                        ...
                                        <div class="input-group date" id="assemblyaddress" data-target-input="nearest">
                                            <input type="text" class="form-control" id="residence_lga-text" tabindex="15" />
                                            <div class="input-group-append">
                                                <div class="input-group-text"><i class="fas fa-thumbtack"></i></div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" data-target-input="nearest">
                                            <input type="text" class="form-control" id="invited_by" name="invited_by" tabindex="16" />
                                            <div class="input-group-append">
                                                <div class="input-group-text"><i class="fa fa-map-marked"></i></div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" data-target-input="nearest">
                                            <input type="date" class="form-control" id="service_date" name="service_date" value="<?php echo date("d-m-Y") ?>" tabindex="17" />
                                            <div class="input-group-append">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content bg-default">
                                        ...
                                        <div class="modal-body">
                                            <p>You are about to save all inputed information to Visitor's Log</p>
                                        </div>
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Close</button>
                                            <button type="submit" name="visitors_register" value="<?php echo base64_encode('visitors_register_form'); ?>" class="btn btn-outline-success">Submit Form</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
