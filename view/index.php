    ...
    <div class="login-box">
        <div class="card card-outline card-warning">
            <div class="card-header text-center">
                <img src="../storage/app/rebiclogo.png" width="200"/>
                <?php
            ...
            <div class="card-body">
                ...
                <form action="../app/authenticator.php" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <button type="submit" name="login_button" value="do_login" class="btn btn-default btn-block">Sign In</button>
                        </div>
